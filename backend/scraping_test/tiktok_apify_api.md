...
POST
https://api.apify.com/v2/acts/apidojo~tiktok-profile-scraper/run-sync?token=***
...
GET
https://api.apify.com/v2/acts/apidojo~tiktok-profile-scraper?token=***
...
GET
https://api.apify.com/v2/acts/apidojo~tiktok-profile-scraper/versions?token=***
...
GET
https://api.apify.com/v2/acts/apidojo~tiktok-profile-scraper/webhooks?token=***
...
PUT
https://api.apify.com/v2/acts/apidojo~tiktok-profile-scraper/versions/0.0?token=***
...
GET
https://api.apify.com/v2/acts/apidojo~tiktok-profile-scraper/builds?token=***
...
POST
https://api.apify.com/v2/acts/apidojo~tiktok-profile-scraper/builds?token=***&version=0.0
...
GET
https://api.apify.com/v2/acts/apidojo~tiktok-profile-scraper/runs/last?token=***
...
GET
https://api.apify.com/v2/acts/apidojo~tiktok-profile-scraper/runs/last/dataset/items?token=***
...
GET
https://api.apify.com/v2/acts/apidojo~tiktok-profile-scraper/builds/default/openapi.json
...
(async () => {
    ...
    const run = await client.actor("ssOXktOBaQQiYfhc4").call(input);
