...
POST
https://api.apify.com/v2/acts/apify~instagram-api-scraper/runs?token=***
...
POST
https://api.apify.com/v2/acts/apify~instagram-api-scraper/run-sync?token=***
...
POST
https://api.apify.com/v2/acts/apify~instagram-api-scraper/run-sync-get-dataset-items?token=***
...
GET
https://api.apify.com/v2/acts/apify~instagram-api-scraper?token=***
...
GET
https://api.apify.com/v2/acts/apify~instagram-api-scraper/versions?token=***
...
GET
https://api.apify.com/v2/acts/apify~instagram-api-scraper/webhooks?token=***
...
PUT
https://api.apify.com/v2/acts/apify~instagram-api-scraper/versions/0.0?token=***
...
GET
https://api.apify.com/v2/acts/apify~instagram-api-scraper/builds?token=***
...
POST
https://api.apify.com/v2/acts/apify~instagram-api-scraper/builds?token=***&version=0.0
...
GET
https://api.apify.com/v2/acts/apify~instagram-api-scraper/runs/last?token=***
...
GET
https://api.apify.com/v2/acts/apify~instagram-api-scraper/runs/last/dataset/items?token=***
...
GET
https://api.apify.com/v2/acts/apify~instagram-api-scraper/builds/default/openapi.json
