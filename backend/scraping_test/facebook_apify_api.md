...
POST
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/runs?token=***
...
POST
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/run-sync?token=***
...
POST
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/run-sync-get-dataset-items?token=***
...
GET
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper?token=***
...
GET
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/versions?token=***
...
GET
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/webhooks?token=***
...
PUT
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/versions/0.0?token=***
...
GET
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/builds?token=***
...
POST
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/builds?token=***&version=0.0
...
GET
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/runs/last?token=***
...
GET
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/runs/last/dataset/items?token=***
...
GET
https://api.apify.com/v2/acts/apify~facebook-followers-following-scraper/builds/default/openapi.json
...
(async () => {
    ...
    const run = await client.actor("hhgonmMEMGmpbDDAN").call(input);
